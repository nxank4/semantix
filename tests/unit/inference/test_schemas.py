...
class TestExtractionResult:
    ...
    def test_missing_reasoning(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ExtractionResult(value=5.5, unit="kg")
    ...
    def test_missing_value(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ExtractionResult(reasoning="Test", unit="kg")
    ...
    def test_missing_unit(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ExtractionResult(reasoning="Test", value=5.5)
    ...
    def test_invalid_value_type(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ExtractionResult(reasoning="Test", value="not_a_number", unit="kg")
    ...
    def test_invalid_reasoning_type(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ExtractionResult(reasoning=123, value=5.5, unit="kg")
    ...
    def test_invalid_unit_type(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ExtractionResult(reasoning="Test", value=5.5, unit=123)
    ...
    def test_json_deserialization(self):
        ...
        result = ExtractionResult(**json_dict)
